...
public class DownloadManager {
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File file = new File(MyApplication.mContext.getFilesDir(), fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(MyApplication.mContext.getFilesDir(), fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            File file = new File(MyApplication.mContext.getFilesDir(), downloadInfo.getFileName());
            InputStream is = null;
