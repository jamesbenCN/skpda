...
public class SecondClassAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.center_listview_item, null);
            holder.nameTV = (TextView) convertView.findViewById(R.id.center_item_name);
