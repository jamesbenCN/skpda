...
public class DSFragment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mContext, R.layout.fragment_get_ds, null);
        want_rv_orderlist = view.findViewById(R.id.rv_get_ds_orderlist);
        initData();
        return view;
    }
    ...
    private List<GetOrderListBean> getData() {
        ...
        data = (new GetOrderListModelDao()).queryData(getActivity(), "getorderlist", "2");
        Log.e("xxx", "ds getData: " + data.size());
        return data;
    }
}
